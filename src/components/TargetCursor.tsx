...
const TargetCursor = ({
  ...
  useEffect(() => {
    ...
    const updateCursorVisibility = () => {
      ...
      if (hasTarget) {
        if (cornersRef.current) gsap.to(cornersRef.current, { opacity: 1, duration: 0.2 });
      } else {
        if (cornersRef.current) gsap.to(cornersRef.current, { opacity: 0, duration: 0.2 });
      }
    };
    ...
    const scrollHandler = () => {
      ...
      if (!isStillOverTarget) {
        handleMouseOver({ target: elementUnderMouse || document.body } as any);
      }
    };
  ...
  return (
    <div ref={cursorRef} className="target-cursor-wrapper">
      <div ref={dotRef} className="target-cursor-dot" style={{ opacity: 0 }} />
      <div className="target-cursor-corner corner-tl" style={{ opacity: 0 }} />
      <div className="target-cursor-corner corner-tr" style={{ opacity: 0 }} />
      <div className="target-cursor-corner corner-br" style={{ opacity: 0 }} />
      <div className="target-cursor-corner corner-bl" style={{ opacity: 0 }} />
    </div>
  );
};
